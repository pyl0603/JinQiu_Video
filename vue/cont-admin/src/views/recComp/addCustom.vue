  ...
  <div>
    ...
    <el-row class="mt20">
      <el-col :span="12"
        ...
        <span
          class="upload-before"
          v-if="commonData.home.logo == ''"
          @click="isPopImg = true,imgSrc='home'"
        >
        ...
        <span
          ...
          @click="isPopImg = true,imgSrc='home'"
        >
          <img :src="commonData.home.logo" alt/></span
      ></el-col>
      <el-col :span="12">客队LOGO：
        <span
          class="upload-before"
          v-if="commonData.away.logo == ''"
          @click="isPopImg = true,imgSrc='away'"
        >
          <svg-icon icon-class="tupian"></svg-icon>
          <span class="f14 cada">120*120</span>
        </span>
        <span
          ...
          @click="isPopImg = true,imgSrc='away'"
        >
          <img :src="commonData.away.logo" alt/></span
      >
      </el-col>
    </el-row>
    <el-row class="mt20">
      <el-col :span="12">主队名称：<el-input v-model="commonData.home.name"></el-input></el-col>
      <el-col :span="12">客队名称：<el-input v-model="commonData.away.name"></el-input></el-col>
    </el-row>
    <el-row class="mt20">
      <el-col :span="12">主队比分：<el-input-number v-model="commonData.score.home"></el-input-number></el-col>
      <el-col :span="12">客队比分：<el-input-number v-model="commonData.score.away"></el-input-number></el-col>
    </el-row>
    <el-row class="mt20">
      关联圈子：
...
export default {
  ...
  methods: {
    ...
    chooseItem(val) {
      console.log(val);
      if(this.imgSrc == 'home'){
        this.commonData.home.logo = val
      }else{
        this.commonData.away.logo = val
      }
      this.isPopImg = false;
    },
    // 状态选择
    ...
    confirm(){
      ...
      if(this.commonData.home.logo == ''){
        this.$message('请上传主队logo')
        return
      }
      if(this.commonData.home.name == ''){
        this.$message('请填写主队名称')
        return
      }
      if(this.commonData.away.logo == ''){
        this.$message('请上传客队logo')
        return
      }
      if(this.commonData.away.name == ''){
        this.$message('请填写客队名称')
        return
      }
