  ...
  data() {
    ...
    return {
      dataRang: [
        ...
        new Date(new Date()).getTime()+3600 * 1000 * 24-1000
      ], //  时间选择
      tableData: [], //列表
      ...
      itemIndex: 0,
      competition: 0, //频道id
      start: new Date(new Date()).getTime(), //开始时间
      end:
        ...
        shortcuts: [
          ...
          },
          {
            ...
            onClick(picker) {
              ...
              _this.start = new Date(new Date()).getTime()-3600 * 1000 * 24 * 3;
              _this.end =
                new Date(new Date()).getTime()+3600 * 1000 * 24-1000;
              _this.dataRang = [_this.start, _this.end];
            }
          },
          {
            ...
            onClick(picker) {
              ...
              picker.$emit("pick", date);
              _this.start = new Date(new Date()).getTime()-3600 * 1000 * 24 * 7;
              _this.end =
                new Date(new Date()).getTime()+3600 * 1000 * 24-1000;
              _this.dataRang = [_this.start, _this.end];
            }
