...
export default {
  ...
  watch:{
    isAddImg(newVal){
      ...
      this.imgUrl.map(res => {
        tinymce.execCommand("mceInsertContent", false, `<img src=${res.fullImgPath} width="100%">`);
      })
      
    },
    isAddVdo(newVal){
      // tinymce.execCommand("mceInsertContent", false, `<video src=${this.videoUrl} controls="controls" width="100%"></video>`);
      tinymce.execCommand("mceInsertContent",false,`<span class="mce-preview-object mce-object-video" contenteditable="false" data-mce-object="video" data-mce-p-allowfullscreen="allowfullscreen" data-mce-p-frameborder="no" data-mce-p-scrolling="no" data-mce-p-src=${this.videoUrl} data-mce-html="%20"><video src=${this.videoUrl} width="100%" preload="auto" autoplay="autoplay" poster="https://duoquxiang.oss-cn-shenzhen.aliyuncs.com/user/2019-09-26/ad040fec3e89490d8600ac5c59eb518e.png" controls="controls"></video></span>`)
    },
    content(newVal){
