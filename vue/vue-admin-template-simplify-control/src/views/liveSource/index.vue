<template>
  <div class="source">
    ...
    >
      ...
      <el-table-column prop="liveSourceNum" label="直播源数量" align="center"></el-table-column>
      ...
      <div class="dialog-cont">
        <div class="list">
          <div class="item mb20" v-for="(item,index) in list" :key="index">
            <div>
              <em>添加链接{{index+1}}：</em>
              <el-input placeholder="请输入" v-model="item.url" v-inputUrl></el-input>
            </div>
            <div class="search-match mt20">
              <em>直播来源：</em>
              <el-input placeholder="请输入" v-model="item.name" maxlength="6"></el-input>
              <el-button
                type="danger"
