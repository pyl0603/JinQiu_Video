  ...
  methods: {
    ...
    finish2() {
      this.$refs.cropper2.getCropData(data => {
        ...
        // let url = '/dev-api/client-admin/aliyun/oss/picture-article'
        let url = 'https://api.jinqiulive.com/client-admin/aliyun/oss/picture-article'
        ...
        return new Promise((resolve, reject) => {
          axios({
            ...
            this.$emit('chooseItem',res.data.data.fullImgPath)
          });
        });
      });
    },
