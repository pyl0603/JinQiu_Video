...
const service = axios.create({
    baseURL: process.env.NODE_ENV === 'development' ? 'http://192.168.1.200:9000/client-bill' : 'https://api.jinqiulive.com/client-bill',
    // baseURL: 'https://api.jinqiulive.com/client-bill',
