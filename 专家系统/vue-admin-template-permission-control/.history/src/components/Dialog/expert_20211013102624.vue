    ...
    >
      ...
      <div class="choose-tab">
        ...
        <div class="el-col-14 ml30 cp tar">
          ...
          ></el-date-picker>
          <div class="tar" v-if="currentTab == 'Live'">
            <el-input
              placeholder="请输入内容"
              v-model="keyworlds"
              maxlength="50"
...
<script>
import Live from "@/views/common/live";
import FMatch from "@/views/common/football-item";
import BMatch from "@/views/common/basketball-item";
