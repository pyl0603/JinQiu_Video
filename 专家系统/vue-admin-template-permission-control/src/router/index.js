...
export const asyncRoutes = [
        ...
        children: [
          {
            ...
            name: '专家活动',
            meta: { title: '专家活动',icon: 'form' ,roles: ['ADMIN', 'APPLICATION_FOOTBALL', 'COMMON_SETTING']}
          }
        ]
      },
      {
        ...
        children: [
          {
            ...
            name: '物流管理',
            meta: { title: '物流管理',icon: 'form' , roles: ['ADMIN', 'CHECK_USER'] }
          }
        ]
      },
    // {
    ...
    //     meta: { title: '物流管理', icon: 'form', roles: ['ADMIN', 'CHECK_USER'] },
    //     children: [
    //       { path: 'Lnvitation', component: ()=>import('@/views/LnvitationLogistics/index'), name: '拉新物流管理', meta: { title: '拉新物流管理',icon: 'form' }},
    //       { path: 'Expert', component: ()=>import('@/views/ExpertLogistics/index'), name: '专家物流管理', meta: { title: '专家物流管理',icon: 'form' }}
    //     ]
    //   },
