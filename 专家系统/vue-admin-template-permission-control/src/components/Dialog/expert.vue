<template>
  <div class="choose-dialog" v-if="showConn">
    ...
    >
      ...
      <div class="cont">
          <ExpertPlan ref="UrlLink" v-show="itemIndex == 'expertPlan'" @associated="associated"></ExpertPlan>
          <UrlLink ref="UrlLink" v-show="itemIndex == 'urlLink'" @matchId="associated" v-if="isUrl"></UrlLink>
      </div>
    </el-dialog>
  </div>
</template>
...
import ExpertPlan from "@/views/common/expert-plan";
export default {
  props: {
    showConn: {
      type: Boolean,
