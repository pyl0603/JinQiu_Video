  ...
  <div class="banner-his">
    ...
    <div class="history mt20">
      ...
      >
        ...
        <el-table-column prop="blackCount" label="历史最大连黑数量"></el-table-column>
        <el-table-column prop="redCount" label="历史最大连红数量"></el-table-column>
        <el-table-column prop="planNumberCount" label="数量总数"></el-table-column>
...
import { users, userDetail,getDetails } from "@/api/user.js";
  ...
  methods: {
    ...
    getUserlist() {
      ...
      getDetails(params).then(res => {
            this.userlist = res.data
            this.totalModal = res.meta.pagination.totalPages
            this.$store.commit("setTotal", res.meta.pagination.totalPages);
