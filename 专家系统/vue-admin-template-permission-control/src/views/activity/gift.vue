  ...
  <div class="banner-his">
    ...
    <div class="history mt20">
      ...
      >
        ...
        <el-table-column prop="group.activityType.display" label="类型"></el-table-column>
    ...
    <el-dialog title="礼品管理" style="margin-top:-10vh" 
      ...
      <Edit @getlist="getIndex" :data="itemDet" :getValue="getValue"></Edit>
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      const res = await getGift({ page: this.page,key:this.key,status:status,activityType:item})
      length = length + res.data.length
        if( this.tableData.length >= length ) return
