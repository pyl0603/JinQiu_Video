...
export default {
  ...
  methods: {
    ...
    async change() {
      ...
      this.item.groupId = this.option.id
    },
    changeGrade(data) {
  ...
  //   this.item.groupId = this.data.group.id;
  //   this.value = this.data.group.activityType.value;
  //   this.groupId = this.data.group.title;
  // },
  ...
  watch: {
    data(newVal,oldVal) {
      if (newVal.id) {
        ...
        this.id = newVal.id;
        this.item = newVal;
        this.contentDet = newVal.display;
        this.item.groupId = newVal.group.id;
        this.value = newVal.group.activityType.value;
        this.groupId = newVal.group.title
      } else {
        this.isAdd = true;
        this.value = "";
        this.groupId = "";
        ...
        this.value = "";
        // this.id = oldVal.id;
        // this.item.groupId = oldVal.group.id;
      }
    },immediate: true,
    　 deep:true
  },
