<template>
  <div>
    <div class="el-col-24 mb30">
      <div class="el-col-18">
        ...
        <el-input
          ...
          class="ml10"
          v-model="keys"
          @keyup.enter.native="getSensi"
        ></el-input>
        <el-button type="dqx-btn" class="ml20" @click="getSensi"
          >查询</el-button
        >
        <el-button type="dqx-btn" class="ml20" @click="resetSensi"
          >重置</el-button
        >
      </div>
    ...
    <el-table :data="tableData" border style="width: 100%;">
      ...
      <el-table-column
        label="调整(上传文档名字应为sensitiveData.txt)"
        width="400"
      >
        <template slot-scope="scope">
          <div class="update">
          ...
          <a
            :href="scope.row.url + '?' + 'timestamp' + timestamp"
            download="test.txt"
            target="_blank"
          >
